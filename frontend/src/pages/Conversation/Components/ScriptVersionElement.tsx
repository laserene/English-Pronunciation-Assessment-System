...
export default function ScriptVersionElement({ id, scenario_id, name }: { id: number, scenario_id: number, name: string }): JSX.Element {
    return (
        <div key={id} data-scenario-id={String(scenario_id)} className="casual-element element-list">
            <div className="casual-element-content">
                {name}
            </div>
            <span>
